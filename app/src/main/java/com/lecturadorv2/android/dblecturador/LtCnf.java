...
public class LtCnf {
    ...
    public boolean obtenerCnf(int id) {
        ...
        if (cursor.moveToNext()) {
            ...
            setCnfIdpr(String.valueOf(cursor.getString(cursor.getColumnIndex(DBhelper.COLCNFIDPR))));
    ...
    public String getCnfIdpr() {
        return CnfIdpr;
    }

    public void setCnfIdpr(String cnfIdpr) {
        CnfIdpr = cnfIdpr;
    }
}
