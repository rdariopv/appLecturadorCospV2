...
//bshpfDrut
                       ...
                       //hpw.setDrut(objHpw.getProperty(20).toString());
                        ...
                        hpw.setNhpf(Integer.valueOf(objHpw.getProperty(0).toString()).intValue());
                        hpw.setNcnt(Integer.valueOf(objHpw.getProperty(1).toString()).intValue());
                        hpw.setLant(Integer.valueOf(objHpw.getProperty(2).toString()).intValue());
                        hpw.setLact(Integer.valueOf(objHpw.getProperty(3).toString()).intValue());
                        hpw.setCons(Integer.valueOf(objHpw.getProperty(4).toString()).intValue());
                        hpw.setFini(objHpw.getProperty(5).toString());
                        hpw.setFfin(objHpw.getProperty(6).toString());
                        hpw.setFvto(objHpw.getProperty(7).toString());
                        hpw.setImpt(Double.parseDouble(objHpw.getProperty(8).toString()));
                        hpw.setDire(objHpw.getProperty(9).toString());
                        hpw.setNmor(Integer.parseInt(objHpw.getProperty(10).toString()));
                        hpw.setImor(Double.parseDouble(objHpw.getProperty(11).toString()));
                        hpw.setCobs(Integer.parseInt(objHpw.getProperty(12).toString()));
                        hpw.setCodf(Integer.parseInt(objHpw.getProperty(13).toString()));
                        hpw.setDias(Integer.parseInt(objHpw.getProperty(14).toString()));
                        hpw.setFcor(objHpw.getProperty(15).toString());
                        hpw.setDnom(objHpw.getProperty(16).toString());
                        hpw.setDcat(objHpw.getProperty(17).toString());
                        hpw.setDciu(objHpw.getProperty(18).toString());
                        hpw.setDuve(objHpw.getProperty(19).toString());
                        hpw.setDmza(objHpw.getProperty(20).toString());
                        hpw.setDlot(objHpw.getProperty(21).toString());
                        hpw.setDbar(objHpw.getProperty(22).toString());
                        hpw.setDimb(objHpw.getProperty(23).toString());
                        hpw.setDzon(objHpw.getProperty(24).toString());
                        hpw.setDrut(objHpw.getProperty(25).toString());
                        hpw.setAnio(Integer.parseInt(objHpw.getProperty(26).toString()));
                        hpw.setDmes(objHpw.getProperty(27).toString());
