        ...
        if (cobs == 0) {
            ...
            if (consumo < 0) {
               ...
               //aqui calcular alcantarilla
                ...
                double imptDescLey=  calcularDescuentoLey(loitemLecturacion.getNhpf());
                double descuentoCovid=    calcularCovid(loitemLecturacion.getNhpf(),importeConsumo+imptAlct);
